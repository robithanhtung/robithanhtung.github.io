...
const tzlibVersion = "1.4.2",
    tzlibZonesDB = {
        ...
        America: {
            ...
            Havana: ["", 29],
            Hermosillo: ["", 22],
            Indiana: { Indianapolis: ["", 23], Knox: ["", 20], Marengo: ["", 23], Petersburg: ["", 23], Tell_City: ["", 20], Vevay: ["", 23], Vincennes: ["", 23], Winamac: ["", 28] },
        ...
        Brazil: { Acre: ["America/Rio_Branco", 18], DeNoronha: ["America/Noronha", 32], East: ["America/Sao_Paulo", 12], West: ["America/Manaus", 17] },
        Canada: {
        ...
        MET: ["", 97],
        Mexico: { BajaNorte: ["America/Tijuana", 24], BajaSur: ["America/Mazatlan", 21], General: ["America/Mexico_City", 30] },
        MST: ["", 22],
        MST7MDT: ["", 19],
...
function tzlib_get_content(e) {
    e = e.split("/");
    return (3 !== e.length || (tzlibZonesDB["" + e[0]] && tzlibZonesDB["" + e[0]]["" + e[1]] && tzlibZonesDB["" + e[0]]["" + e[1]]["" + e[2]])) &&
        (2 !== e.length || (tzlibZonesDB["" + e[0]] && tzlibZonesDB["" + e[0]]["" + e[1]])) &&
        (1 !== e.length || tzlibZonesDB["" + e[0]])
        ? 3 === e.length
            ? [tzlibZonesDB["" + e[0]]["" + e[1]]["" + e[2]][0], tzlib_enrich_data(tzlibZonesDetailsDB[tzlibZonesDB["" + e[0]]["" + e[1]]["" + e[2]][1]])]
            : 2 === e.length
            ? [tzlibZonesDB["" + e[0]]["" + e[1]][0], tzlib_enrich_data(tzlibZonesDetailsDB[tzlibZonesDB["" + e[0]]["" + e[1]][1]])]
            : [tzlibZonesDB["" + e[0]][0], tzlib_enrich_data(tzlibZonesDetailsDB[tzlibZonesDB["" + e[0]][1]])]
...
function tzlib_get_offset(e, a, t) {
    ...
    if (!a.match(/^\d{4}-\d{2}-\d{2}$/)) return console.error("offset calculation failed: date misspelled [-> YYYY-MM-DD]"), "";
    if (!t.match(/^\d{2}:\d{2}$/)) return console.error("offset calculation failed: time misspelled [-> hh:mm]"), "";
    if (!e[1].match(/BEGIN:DAYLIGHT/i)) return e[1].match(/TZOFFSETTO:([+|-]\d{4})/i)[1];
    (a = new Date(a + "T" + t + ":00")), (t = a.getFullYear());
    const n = a.getMonth() + 1;
    var o,
        i,
        l = a.getDate(),
        a = a.getHours(),
        r = e[1].replace(/[^\w_\-:,;=+/<br>]/g, "").split("<br>");
    const s = { 1: {}, 2: {} };
    let c = 0;
    for (let e = 0; e < r.length; e++)
        r["" + e].startsWith("TZOFFSETTO") && (c++, (s["" + c].offset = r["" + e].split(":")[1])),
            r["" + e].startsWith("DTSTART") && (s["" + c].hour = parseInt(r["" + e].substr(17, 2))),
            r["" + e].startsWith("RRULE") && ((o = r["" + e].split(";")), (i = parseInt(o[1].split("=")[1])), (s["" + c].month = parseInt(i)), (s["" + c].day = o[2].split("=")[1]));
    if ((s[1].month > s[2].month && ([s[1], s[2]] = [s[2], s[1]]), n != s[1].month && n != s[2].month)) return (n < s[1].month || n > s[2].month ? s[2] : s[1]).offset;
    ...
    var g,
        t = "-" == s["" + d].day[0] ? ((g = s["" + d].day.substr(2, 2)), (e = Object.keys(p["" + g]).length + 1 - parseInt(s["" + d].day[1])), p["" + g]["" + e]) : ((g = s["" + d].day.substr(1, 2)), p["" + g][s["" + d].day[0]]);
    return (t < l || (l == t && a >= s["" + d].hour) ? s["" + d] : ((e = 1 == d ? 2 : 1), s["" + e])).offset;
}
let tzlibZoneNames = [];
function tzlib_get_timezones(e = !1) {
    return (
        0 == tzlibZoneNames.length &&
            (tzlibZoneNames = (function () {
                var e,
                    a,
                    t = [];
                for ([e, a] of Object.entries(tzlibZonesDB))
                    if ("object" != typeof a || Array.isArray(a)) t.push(e);
                    else
                        for (var [n, o] of Object.entries(a))
                            if ("object" != typeof o || Array.isArray(o)) t.push(e + "/" + n);
                            else for (var [i] of Object.entries(o)) t.push(e + "/" + n + "/" + i);
                return t;
            })()),
...
function atcb_patch_config(a) {
    null != a.event &&
        (Object.keys(a.event).forEach((e) => {
            "@" !== e.charAt(0) && (a["" + e] = a.event["" + e]);
        }),
        delete a.event);
    const t = { title: "name", dateStart: "startDate", dateEnd: "endDate", timeStart: "startTime", timeEnd: "endTime" };
    return (
...
function atcb_decorate_data(e) {
    return (
        ((e = atcb_decorate_data_identifier(e)).subscribe = atcb_decorate_data_subscribe(e)),
...
function atcb_decorate_data_identifier(e) {
    return (
        null != e.identifier &&
            "" != e.identifier &&
            ((e.identifier = "atcb-btn-" + e.identifier), /^[\w-]+$/.test(e.identifier) || ((e.identifier = ""), console.warn("Add to Calendar Button generation: identifier invalid - using auto numbers instead"))),
        e
    );
}
...
function atcb_decorate_data_rrule(e) {
    if (null != e.recurrence && "" != e.recurrence)
            ...
            if (/^RRULE:/i.test(e.recurrence)) {
                ...
                (null != e.recurrence_interval && "" != e.recurrence_interval) || (e.recurrence_interval = 1),
                    ...
                    null != e.recurrence_until &&
                        "" != e.recurrence_until &&
                        (null != e.endTime && "" != e.endTime
                            ? (e.recurrence = e.recurrence + ";UNTIL=" + e.recurrence_until.replace(/-/g, "").slice(0, 8) + "T" + e.endTime.replace(":", "") + "00")
                            : (e.recurrence = e.recurrence + ";UNTIL=" + e.recurrence_until.replace(/-/g, "").slice(0, 8))),
        ...
        else e.recurrence = "!wrong rrule format!";
    return e;
}
function atcb_decorate_data_options(a) {
    ...
    for (let e = 0; e < a.options.length; e++) {
        ...
        var n = i[0].toLowerCase().replace("microsoft", "ms").replace(".", ""),
            o = null != i[1] ? i[1] : "";
        (isiOS() && atcbiOSInvalidOptions.includes(n)) ||
            (null != a.recurrence && "" != a.recurrence && (!atcbValidRecurrOptions.includes(n) || (null != a.recurrence_until && "" != a.recurrence_until && ("apple" == n || "ical" == n)))) ||
            (a.subscribe && atcbInvalidSubscribeOptions.includes(n)) ||
            (t.push(n), a.optionLabels.push(o));
    }
...
function atcb_decorate_data_branding(e) {
    return null != e.branding && e.branding, !1;
}
...
function atcb_decorate_data_style(e) {
    if (
        ((null != e.listStyle && "" != e.listStyle) || (e.listStyle = "dropdown"),
        "modal" === e.listStyle && (e.trigger = "click"),
        null != e.buttonStyle && "" != e.buttonStyle && "default" != e.buttonStyle
            ? (("bubble" != e.buttonStyle && "text" != e.buttonStyle && "date" != e.buttonStyle) || (e.trigger = "click"), "date" == e.buttonStyle && "dropdown" == e.listStyle && (e.listStyle = "overlay"))
            : (e.buttonStyle = ""),
        (e.sizes = []),
        ...
        var a = e.size.split("|");
        for (let e = 0; e < a.length; e++) a["" + e] = parseInt(a["" + e]);
        0 <= a[0] && a[0] < 11 && (e.sizes.l = 10 + a[0]),
            2 < a.length ? (0 <= a[1] && a[1] < 11 && (e.sizes.m = 10 + a[1]), 0 <= a[2] && a[2] < 11 && (e.sizes.s = 10 + a[2])) : 2 == a.length && 0 <= a[1] && a[1] < 11 && (e.sizes.m = e.sizes.s = 10 + a[1]);
    }
    if (null == e.lightMode || "" == e.lightMode) e.lightMode = "light";
    ...
    return (
        ...
        (e.iconModal = !0),
        null != e.icons &&
            ((e.icons = String(e.icons)), "" != e.icons && ("false" == (n = e.icons.split("|"))[0] && (e.iconButton = !1), null != n[1] && "false" == n[1] && (e.iconList = !1), null != n[2] && "false" == n[2] && (e.iconModal = !1))),
        (e.textLabelButton = !0),
        (e.textLabelList = !0),
        null != e.textLabels && ((e.textLabels = String(e.textLabels)), "" != e.textLabels && ("false" == (n = e.textLabels.split("|"))[0] && (e.textLabelButton = !1), null != n[1] && "false" == n[1] && (e.textLabelList = !1))),
        e
    );
}
function atcb_decorate_data_i18n(e) {
    return (null != e.language && "" != e.language) || (e.language = "en"), "ar" == e.language ? (e.rtl = !0) : (e.rtl = !1), e;
}
function atcb_decorate_data_dates(a) {
    ...
    e = new Date();
    return (null != a.created && "" != a.created) || (a.created = atcb_format_datetime(e, "clean", !0)), (null != a.updated && "" != a.updated) || (a.updated = atcb_format_datetime(e, "clean", !0)), a;
}
function atcb_decorate_data_meta(e) {
    return (null != e.status && "" != e.status) || (e.status = "CONFIRMED"), (null != e.sequence && "" != e.sequence) || (e.sequence = 0), e;
}
function atcb_decorate_data_description(e, a) {
    return (
        null != e.dates["" + a].description && "" != e.dates["" + a].description
            ? ((e.dates["" + a].descriptionHtmlFree = atcb_rewrite_html_elements(e.dates["" + a].description, !0)), (e.dates["" + a].description = atcb_rewrite_html_elements(e.dates["" + a].description)))
            : null == e.dates["" + a].description && null != e.description && "" != e.description
            ? ((e.dates["" + a].descriptionHtmlFree = atcb_rewrite_html_elements(e.description, !0)), (e.dates["" + a].description = atcb_rewrite_html_elements(e.description)))
            : (e.dates["" + a].descriptionHtmlFree = e.dates["" + a].description = ""),
        e
    );
}
function atcb_decorate_data_extend(a) {
    for (let e = 0; e < a.dates.length; e++)
        (null != (a = atcb_decorate_data_description(a, e)).dates["" + e].name && "" != a.dates["" + e].name) || (a.dates["" + e].name = a.name),
            ...
            null == a.dates["" + e].availability && null != a.availability
                ? (a.dates["" + e].availability = a.availability.toLowerCase())
                : null != a.dates["" + e].availability && (a.dates["" + e].availability = a.dates["" + e].availability.toLowerCase()),
            null == a.dates["" + e].uid && (a.dates["" + e].uid = atcb_generate_uuid());
    return null != a.recurrence && "" != a.recurrence && (a.dates[0].recurrence = a.recurrence), 1 < a.dates.length && a.dates.sort((e, a) => e.timestamp - a.timestamp), a;
}
function atcb_date_cleanup(n) {
    ...
    return (
        ["start", "end"].forEach(function (e) {
            var a;
            null != n[e + "Date"] && ((n[e + "Date"] = n[e + "Date"].replace(/\.\d{3}/, "").replace("Z", "")), null != (a = n[e + "Date"].split("T"))[1] && ((n[e + "Date"] = a[0]), (n[e + "Time"] = a[1]))),
                null != n[e + "Time"] && 8 === n[e + "Time"].length && ((a = n[e + "Time"]), (n[e + "Time"] = a.substring(0, a.length - 3))),
                "currentBrowser" == n.timeZone && (n.timeZone = Intl.DateTimeFormat().resolvedOptions().timeZone);
            let t;
            (t = null != n[e + "Time"] ? new Date(n[e + "Date"] + " " + n[e + "Time"]) : new Date(n[e + "Date"])), (n[e + "Timestamp"] = t.getTime());
        }),
        n
    );
}
function atcb_date_calculation(e) {
    ...
    return null != a[1] && 0 < a[1] && e.setDate(e.getDate() + parseInt(a[1])), e.toISOString().replace(/T(\d{2}:\d{2}:\d{2}\.\d{3})Z/g, "");
}
function atcb_check_required(t) {
    if (null == t.options || t.options.length < 1) return console.error("Add to Calendar Button generation failed: no valid options set"), !1;
    if (null == t.name || "" == t.name) return console.error("Add to Calendar Button generation failed: required name information missing"), !1;
    if (null != t.dates && 0 < t.dates.length) {
        const n = ["name"];
        return ["name", "startDate"].every(function (a) {
            for (let e = 0; e < t.dates.length; e++)
                if (
                    (!n.includes("" + a) && (null == t.dates["" + e]["" + a] || "" == t.dates["" + e]["" + a])) ||
                    (n.includes("" + a) && (null == t.dates["" + e]["" + a] || "" == t.dates["" + e]["" + a]) && (null == t["" + a] || "" == t["" + a]))
                )
                    return console.error("Add to Calendar Button generation failed: required setting missing [dates array object #" + (e + 1) + "/" + t.dates.length + "] => [" + a + "]"), !1;
            return !0;
        });
    }
    return ["startDate"].every(function (e) {
        return (null != t["" + e] && "" != t["" + e]) || (console.error("Add to Calendar Button generation failed: required setting missing [" + e + "]"), !1);
    });
}
function atcb_validate(e) {
    var a = "Add to Calendar Button generation (" + e.identifier + ")";
    return (
        !!atcb_validate_icsFile(e, a) && !!atcb_validate_subscribe(e, a) && !!atcb_validate_created(e, a) && !!atcb_validate_updated(e, a) && !!atcb_validate_options(e, a) && !!atcb_validate_date_blocks(e, a) && !!atcb_validate_rrule(e, a)
    );
}
function atcb_validate_icsFile(e, a, t = "", n = "") {
    t = "" != t && null != e.dates["" + t].icsFile ? e.dates["" + t].icsFile : "" == t && null != e.icsFile ? e.icsFile : "";
    return (
        !("" != t && (!atcb_secure_url(t, !1) || (!/^https:\/\/(.)*\.ics$/m.test(e.icsFile) && !e.subscribe) || (!e.icsFile.startsWith("https://") && e.subscribe))) || (console.error(a + " failed: explicit ics file path not valid" + n), !1)
    );
}
function atcb_validate_subscribe(e, a) {
    return 1 != e.subscribe || (null != e.icsFile && "" != e.icsFile) || (console.error(a + " failed: a subscription calendar requires a valid explicit ics file as well"), !1);
}
function atcb_validate_created(e, a) {
    return !!/^\d{8}T\d{6}Z$/.test(e.created) || (console.error(a + " failed: created date format not valid. Needs to be a full ISO-8601 UTC date and time string, formatted YYYYMMDDTHHMMSSZ"), !1);
}
function atcb_validate_updated(e, a) {
    return !!/^\d{8}T\d{6}Z$/.test(e.updated) || (console.error(a + " failed: updated date format not valid. Needs to be a full ISO-8601 UTC date and time string, formatted YYYYMMDDTHHMMSSZ"), !1);
}
function atcb_validate_options(e, a) {
    return !!e.options.every(function (e) {
        return !!atcbOptions.includes(e) || (console.error(a + " failed: invalid option [" + e + "]"), !1);
    });
}
function atcb_validate_date_blocks(a, t) {
    for (let e = 0; e < a.dates.length; e++) {
        var n = 1 == a.dates.length ? "" : " [dates array object #" + (e + 1) + "/" + a.dates.length + "] ";
        if (!atcb_validate_icsFile(a, t, e, n)) return !1;
        if (!atcb_validate_status(a, t, e, n)) return !1;
        if (!atcb_validate_availability(a, t, e, n)) return !1;
        if (!atcb_validate_organizer(a, t, e, n)) return !1;
        if (!atcb_validate_uid(a, t, e, n)) return !1;
        if (!atcb_validate_sequence(a, t, e, n)) return !1;
        if (!atcb_validate_timezone(a, t, e, n)) return !1;
        if (!atcb_validate_datetime(a, t, e, n)) return !1;
    }
    return !0;
}
function atcb_validate_status(e, a, t, n) {
    return "TENTATIVE" == e.dates["" + t].status || "CONFIRMED" == e.dates["" + t].status || "CANCELLED" == e.dates["" + t].status || (console.error(a + " failed: event status needs to be TENTATIVE, CONFIRMED, or CANCELLED" + n), !1);
}
function atcb_validate_availability(e, a, t, n) {
    return (
        ...
        "busy" == e.dates["" + t].availability ||
        (console.error(a + ' failed: event availability needs to be "free" or "busy"' + n), !1)
    );
}
function atcb_validate_organizer(e, a, t, n) {
    if (null != e.dates["" + t].organizer && "" != e.dates["" + t].organizer) {
        e = e.dates["" + t].organizer.split("|");
        if (2 != e.length || 50 < e[0].length || 80 < e[1].length || !atcb_validEmail(e[1])) return console.error(a + ' failed: organizer needs to match the schema "NAME|EMAIL" with a valid email address' + n), !1;
    }
    return !0;
}
function atcb_validate_uid(e, a, t, n) {
    return (
        /^(\w|-){1,254}$/.test(e.dates["" + t].uid) ||
            (console.warn(a + ": UID not valid. May only contain alpha, digits, and dashes; and be less than 255 characters. Falling back to an automated value!" + n), (e.dates["" + t].uid = atcb_generate_uuid())),
...
function atcb_validate_sequence(e, a, t, n) {
    return /^\d+$/.test(e.dates["" + t].sequence) || (console.log(a + ": sequence needs to be a number. Used the default 0 instead" + n), (e.dates["" + t].sequence = 0)), !0;
}
function atcb_validate_timezone(e, a, t, n) {
    if (null != e.dates["" + t].timeZone && "" != e.dates["" + t].timeZone && !tzlib_get_timezones().includes(e.dates["" + t].timeZone)) return console.error(a + " failed: invalid time zone given" + n), !1;
    return !0;
}
function atcb_validate_datetime(t, n, o, i) {
    ...
    return (
        !!e.every(function (e) {
            var a;
            return 10 !== t.dates["" + o]["" + e].length
                ? (console.error(n + " failed: date misspelled [-> YYYY-MM-DD]" + i), !1)
                : (a = t.dates["" + o]["" + e].split("-")).length < 3 || 3 < a.length
                ? (console.error(n + " failed: date misspelled [" + e + ": " + t.dates["" + o]["" + e] + "]" + i), !1)
                : ((l["" + e] = new Date(a[0], a[1] - 1, a[2])), !0);
        }) &&
        !!["startTime", "endTime"].every(function (e) {
            if (null != t.dates["" + o]["" + e]) {
                if (5 !== t.dates["" + o]["" + e].length) return console.error(n + " failed: time misspelled [-> HH:MM]" + i), !1;
                var a = t.dates["" + o]["" + e].split(":");
                if (a.length < 2 || 2 < a.length) return console.error(n + " failed: time misspelled [" + e + ": " + t.dates["" + o]["" + e] + "]" + i), !1;
                if (23 < a[0]) return console.error(n + " failed: time misspelled - hours number too high [" + e + ": " + a[0] + "]" + i), !1;
                if (59 < a[1]) return console.error(n + " failed: time misspelled - minutes number too high [" + e + ": " + a[1] + "]" + i), !1;
                "startTime" == e && (l.startDate = new Date(l.startDate.getTime() + 36e5 * a[0] + 6e4 * a[1])), "endTime" == e && (l.endDate = new Date(l.endDate.getTime() + 36e5 * a[0] + 6e4 * a[1]));
            }
            return !0;
        }) &&
        ((null != t.dates["" + o].startTime && null == t.dates["" + o].endTime) || (null == t.dates["" + o].startTime && null != t.dates["" + o].endTime)
            ? (console.error(n + " failed: if you set a starting time, you also need to define an end time" + i), !1)
            : !(l.endDate < l.startDate) || (console.error(n + " failed: end date before start date" + i), !1))
    );
}
function atcb_validate_rrule(e, a) {
    return null != e.recurrence && "" != e.recurrence && 1 < e.dates.length
        ? (console.error(a + " failed: RRULE and multi-date set at the same time"), !1)
        : null == e.recurrence || "" == e.recurrence || /^RRULE:[\w=;,:+-/\\]+$/i.test(e.recurrence)
        ? null == e.recurrence_interval || "" == e.recurrence_interval || /^\d+$/.test(e.recurrence_interval)
            ? null == e.recurrence_until || "" == e.recurrence_until || /^(\d|-|:)+$/i.test(e.recurrence_until)
                ? null == e.recurrence_count || "" == e.recurrence_count || /^\d+$/.test(e.recurrence_count)
                    ? null == e.recurrence_byMonth || "" == e.recurrence_byMonth || /^(\d|,)+$/.test(e.recurrence_byMonth)
                        ? null == e.recurrence_byMonthDay || "" == e.recurrence_byMonthDay || /^(\d|,)+$/.test(e.recurrence_byMonthDay)
                            ? null == e.recurrence_byDay || "" == e.recurrence_byDay || /^(\d|-|MO|TU|WE|TH|FR|SA|SU|,)+$/im.test(e.recurrence_byDay)
                                ? !(null != e.recurrence_weekstart && "" != e.recurrence_weekstart && !/^(MO|TU|WE|TH|FR|SA|SU)$/im.test(e.recurrence_weekstart)) || (console.error(a + " failed: recurrence data (weekstart) misspelled"), !1)
                                : (console.error(a + " failed: recurrence data (byDay) misspelled"), !1)
                            : (console.error(a + " failed: recurrence data (byMonthDay) misspelled"), !1)
                        : (console.error(a + " failed: recurrence data (byMonth) misspelled"), !1)
                    : (console.error(a + " failed: recurrence data (interval) misspelled"), !1)
                : (console.error(a + " failed: recurrence data (until) misspelled"), !1)
            : (console.error(a + " failed: recurrence data (interval) misspelled"), !1)
        : (console.error(a + " failed: RRULE data misspelled"), !1);
}
        ...
        l.classList.add("atcb-list-wrapper"),
            ...
            a
                ? (a.classList.add("atcb-active"),
                  "modal" === e.listStyle
                      ? (a.classList.add("atcb-modal-style"), o.classList.add("atcb-modal"))
                      : (l.appendChild(o), l.classList.add("atcb-dropdown"), "overlay" === e.listStyle && l.classList.add("atcb-dropoverlay"), e.mindScrolling && l.classList.add("atcb-mind-scrolling")),
                  n && o.classList.add("atcb-generated-button"))
                : o.classList.add("atcb-modal");
        var i,
            n = atcb_generate_bg_overlay(e.listStyle, e.trigger, e.lightMode, e.background);
        "modal" === e.listStyle
            ...
            : (((i = document.createElement("div")).id = "atcb-pos-wrapper"),
              ...
              setTimeout(function () {
                  (l.style.display = "block"), "dropdown-static" === e.listStyle ? atcb_position_list(a, l, !0) : atcb_position_list(a, l);
              }, 5)),
            atcb_set_fullsize(n),
            t ? o.firstChild.focus() : o.firstChild.focus({ preventScroll: !0 }),
            o.firstChild.blur();
    }
}
function atcb_close(a = !1) {
    ...
    if (1 < t.length) {
        ...
        (e = 0 < t.length ? t[0] : e).focus(), a || e.blur();
    } else {
        t = document.querySelector(".atcb-active, .atcb-active-modal");
        t && (t.focus({ preventScroll: !0 }), a || t.blur()),
            ...
            (t.id = a.identifier),
                "click" === a.trigger
                    ? t.addEventListener("click", (e) => {
                          e.preventDefault(), atcb_toggle("auto", a, t, !1, !0);
                      })
                    : (t.addEventListener("touchend", (e) => {
                      ...
                      t.addEventListener(
                          ...
                          atcb_debounce_leading((e) => {
                              e.preventDefault(), atcb_toggle("open", a, t, !1, !0);
                          })
                      )),
                t.addEventListener("keyup", function (e) {
                    "Enter" == e.key && (e.preventDefault(), atcb_toggle("auto", a, t, !0, !0));
                });
            break;
        case "apple":
        case "google":
        ...
        case "yahoo":
            (t.id = a.identifier + "-" + n),
                t.addEventListener(
                    "click",
                    atcb_debounce(() => {
                        i ? t.blur() : atcb_toggle("close"), atcb_generate_links(n, a);
                    })
                ),
                t.addEventListener("keyup", function (e) {
                    "Enter" == e.key && (e.preventDefault(), i ? t.blur() : atcb_toggle("close"), atcb_generate_links(n, a, "all", !0));
                });
            break;
        case "close":
            (t.id = a.identifier + "-close"),
                ...
                t.addEventListener("keyup", function (e) {
                    "Enter" == e.key && (e.preventDefault(), atcb_toggle("close", a, "all", !0));
                });
    }
    i && (t.id = a.identifier), atcb_generate_label_content(a, t, n, e, o, i);
}
function atcb_generate_label_content(e, a, t, n, o, i) {
    ...
    ("date" == e.buttonStyle && ("trigger" == t || i)) ||
        (n && ((i = document.createElement("span")).classList.add("atcb-icon"), (i.innerHTML = atcbIcon["" + t]), a.appendChild(i)),
        (("trigger" == t && 1 == e.textLabelButton) || ("trigger" != t && 1 == e.textLabelList)) && ((n = document.createElement("span")).classList.add("atcb-text"), (n.textContent = o), a.appendChild(n)));
}
function atcb_generate_button(e, a) {
    (e.textContent = ""), a.richData && a.name && a.dates[0].location && a.dates[0].startDate && atcb_generate_rich_data(a, e);
    var t = document.createElement("div"),
        n = (t.classList.add("atcb-button-wrapper"), t.classList.add("atcb-" + a.lightMode), a.rtl && t.classList.add("atcb-rtl"), e.appendChild(t), atcb_set_sizes(t, a.sizes), document.createElement("button"));
    n.classList.add("atcb-button"),
        ...
        1 === a.options.length
            ? (n.classList.add("atcb-single"), atcb_generate_label(a, n, a.options[0], a.iconButton, a.label, !0))
            : (atcb_generate_label(a, n, "trigger", a.iconButton, a.label), (t = document.createElement("div")).classList.add("atcb-dropdown-anchor"), n.appendChild(t)),
        a.checkmark && ((t = document.createElement("div")).classList.add("atcb-checkmark"), (t.innerHTML = atcbIcon.checkmark), n.appendChild(t)),
...
function atcb_generate_rich_data(a, e) {
    var t,
        ...
        o = ((n.type = "application/ld+json"), []),
        i =
            (1 < a.dates.length &&
                ((t = []).push('"@context":"https://schema.org"'), t.push('"@type":"EventSeries"'), t.push('"@id":"' + a.name.replace(/\s/g, "") + '"'), t.push('"name":"' + a.name + '",'), o.push("{\r\n" + t.join(",\r\n") + "\r\n")),
            []);
    for (let e = 0; e < a.dates.length; e++) {
        var l = [],
            r =
            ...
            s =
                (l.push('"startDate":"' + r.start + '"'),
                null != r.duration && l.push('"duration":"' + r.duration + '"'),
                l.push(
                    a.dates["" + e].location.startsWith("http")
                ...
                null != a.dates["" + e].organizer && "" != a.dates["" + e].organizer && ((r = a.dates["" + e].organizer.split("|")), l.push('"organizer":{\r\n"@type":"Person",\r\n"name":"' + r[0] + '",\r\n"email":"' + r[1] + '"\r\n}')),
                []);
        if (null != a.images) {
            if (Array.isArray(a.images)) for (let e = 0; e < a.images.length; e++) atcb_secure_url(a.images["" + e]) && a.images["" + e].startsWith("http") && s.push('"' + a.images["" + e] + '"');
        } else s.push('"https://add-to-calendar-button.com/demo_assets/img/1x1.png"'), s.push('"https://add-to-calendar-button.com/demo_assets/img/4x3.png"'), s.push('"https://add-to-calendar-button.com/demo_assets/img/16x9.png"');
        0 < s.length && l.push('"image":[\r\n' + s.join(",\r\n") + "]"), i.push("{\r\n" + l.join(",\r\n") + "\r\n}");
    }
    1 < a.dates.length ? (n.textContent = o.join(",\r\n") + '"subEvents":[\r\n' + i.join(",\r\n") + "\r\n]\r\n}") : (n.textContent = i[0]), e.appendChild(n);
}
function atcb_generate_rich_data_recurrence(e, a) {
    var t = [],
        n =
            (t.push('"eventSchedule": { "@type": "Schedule"'),
    ...
    return (
        t.push('"repeatFrequency":"' + n + '"'),
        null != e.recurrence_byDay &&
            "" != e.recurrence_byDay &&
            ((n = (function () {
            ...
            t.push('"byDay":' + n)),
        null != e.recurrence_byMonth && "" != e.recurrence_byMonth && ((n = e.recurrence_byMonth.includes(",") ? "[" + e.recurrence_byMonth + "]" : e.recurrence_byMonth), t.push('"byMonth":"' + n + '"')),
        null != e.recurrence_byMonthDay && "" != e.recurrence_byMonthDay && ((n = e.recurrence_byMonthDay.includes(",") ? "[" + e.recurrence_byMonthDay + "]" : e.recurrence_byMonthDay), t.push('"byMonthDay":"' + n + '"')),
        ...
        null != e.startTime && "" != e.startTime && null != e.endTime && "" != e.endTime && (t.push('"startTime":"' + e.startTime + ':00"'), t.push('"endTime":"' + e.endTime + ':00"'), t.push('"duration":"' + a.duration + '"')),
...
function atcb_generate_dropdown_list(t) {
    ...
    n.classList.add("atcb-list"), n.classList.add("atcb-" + t.lightMode), t.rtl && n.classList.add("atcb-rtl");
    let o = 0;
    var e;
    return (
        t.options.forEach(function (e) {
            var a = document.createElement("div");
            a.classList.add("atcb-list-item"), (a.tabIndex = 0), o++, (a.dataset.optionNumber = o), n.appendChild(a), atcb_generate_label(t, a, e, t.iconList, t.optionLabels[o - 1]);
        }),
        "modal" === t.listStyle && ((e = document.createElement("div")).classList.add("atcb-list-item", "atcb-list-item-close"), (e.tabIndex = 0), n.appendChild(e), atcb_generate_label(t, e, "close", t.iconList)),
        n
    );
}
function atcb_generate_bg_overlay(e = "dropdown", a = "", t = "light", n = !0) {
    ...
    return (
        o.addEventListener(
            "touchstart",
            atcb_debounce_leading(() => (i = !1)),
            { passive: !0 }
        ),
        o.addEventListener(
            "touchmove",
            atcb_debounce_leading(() => (i = !0)),
            { passive: !0 }
        ),
        o.addEventListener(
            "touchend",
...
function atcb_create_modal(n, e = "", a, t = "", o = [], i = [], l = !1) {
    var r = document.getElementById("atcb-bgoverlay") || atcb_generate_bg_overlay("modal", "click", n.lightMode, n.background),
        s = (r.classList.add("atcb-no-animation"), document.body.appendChild(r), document.createElement("div")),
        c = (s.classList.add("atcb-modal"), r.appendChild(s), document.querySelectorAll(".atcb-modal").length),
        d = ((s.dataset.modalNr = c), (s.tabIndex = 0), s.focus({ preventScroll: !0 }), s.blur(), document.getElementById(n.identifier)),
        d = (null != d && d.classList.add("atcb-active-modal"), document.createElement("div")),
        e =
            (d.classList.add("atcb-modal-box"),
            d.classList.add("atcb-" + n.lightMode),
            n.rtl && d.classList.add("atcb-rtl"),
            s.appendChild(d),
            atcb_set_sizes(d, n.sizes),
            atcb_set_fullsize(r),
            "" != e && 1 == n.iconModal && ((r = document.createElement("div")).classList.add("atcb-modal-icon"), (r.innerHTML = atcbIcon["" + e]), d.appendChild(r)),
            document.createElement("div"));
    if ((e.classList.add("atcb-modal-headline"), (e.textContent = a), d.appendChild(e), "" != t && ((r = document.createElement("div")).classList.add("atcb-modal-content"), (r.innerHTML = t), d.appendChild(r)), 1 < i.length)) {
        n.branding && atcb_create_atcbl(!1);
        var u = document.createElement("div");
        u.classList.add("atcb-modal-content"), d.appendChild(u);
    ...
    0 == o.length && o.push({ type: "close", label: atcb_translate_hook("Close", n) });
    ...
    b.classList.add("atcb-modal-buttons"),
        ...
        o.forEach((e, a) => {
            ...
            switch (
                (null != e.href && "" != e.href
                    ? ((t = document.createElement("a")).setAttribute("target", atcbDefaultTarget), t.setAttribute("href", e.href), t.setAttribute("rel", "noopener"))
                ...
                case "yahoo2nd":
                    t.addEventListener(
                        "click",
                        atcb_debounce(() => {
                            atcb_close(), atcb_subscribe_yahoo_modal_switch(n);
                        })
                    ),
                        t.addEventListener("keyup", function (e) {
                            "Enter" == e.key && (atcb_toggle("close", "", "", !0), atcb_subscribe_yahoo_modal_switch(n, l));
                        });
                    break;
                case "none":
            }
...
function atcb_subscribe_yahoo_modal_switch(e, a) {
    atcb_set_fully_successful(e.identifier), atcb_generate_links("yahoo2nd", e, "all", a);
}
    ...
    var a = (function () {
            let e,
                ...
                l =
                    ((n =
                        "all" == m
                            ? ((o = atcb_generate_time(u.dates[0])), (i = atcb_generate_time(u.dates[u.dates.length - 1])), (t = u.dates[0].timeZone), u.dates[u.dates.length - 1].timeZone)
                            : ((o = atcb_generate_time(u.dates["" + m])), (i = o), (t = u.dates["" + m].timeZone))),
                    (e = new Date(o.start)),
                    (a = new Date(i.end)),
                ...
                r = "",
                s = "";
            o.allday || Intl.DateTimeFormat().resolvedOptions().timeZone == t || t == n || (r = " (" + t + ")"), ((i.allday || Intl.DateTimeFormat().resolvedOptions().timeZone == n) && t == n) || (s = " (" + n + ")");
            var c = get_format_options(t),
                d = get_format_options(n);
            return (
                e.getFullYear() === a.getFullYear() && e.getMonth() === a.getMonth() && e.getDate() === a.getDate()
                    ? (l = o.allday ? e.toLocaleDateString(u.language, c.DateShort) : e.toLocaleString(u.language, c.DateTimeShort) + r + " - " + a.toLocaleTimeString(u.language, d.Time) + s)
                    : ((l = o.allday ? e.toLocaleDateString(u.language, c.DateShort) : e.toLocaleString(u.language, c.DateTimeShort)),
                      (l += r + " - "),
        ...
        o = ("all" == m && (m = 0), new Date(u.dates["" + m].startDate)),
        i = null != u.dates["" + m].timeZone && "" != u.dates["" + m].timeZone ? u.dates["" + m].timeZone : "UTC",
        l = document.createElement("div"),
        r = (l.classList.add("atcb-date-btn-left"), e.appendChild(l), document.createElement("div")),
        s = (r.classList.add("atcb-date-btn-day"), l.appendChild(r), document.createElement("div")),
        r =
            (s.classList.add("atcb-date-btn-month"),
            (r.textContent = o.toLocaleString(u.language, { day: "numeric", timeZone: i })),
            (s.textContent = o.toLocaleString(u.language, { month: "short", timeZone: i })),
            l.appendChild(s),
            document.createElement("div")),
        o = (r.classList.add("atcb-date-btn-right"), e.appendChild(r), document.createElement("div")),
        i = (o.classList.add("atcb-date-btn-details"), r.appendChild(o), document.createElement("div")),
        n =
            (i.classList.add("atcb-date-btn-headline"),
            (i.textContent = u.dates["" + m].name),
            o.appendChild(i),
            ((null != u.location && "" != u.location) || "" != n) &&
                ((l = document.createElement("div")).classList.add("atcb-date-btn-content"),
                o.appendChild(l),
                "" != n
                    ? ((l.textContent = n), (l.style.fontWeight = "600"), (l.style.color = "#9c1a23"))
                    : (l.classList.add("atcb-date-btn-content-location"),
                      ...
                      l.appendChild(i))),
            document.createElement("div")),
        s = (n.classList.add("atcb-date-btn-content"), o.appendChild(n), document.createElement("span")),
        l = (s.classList.add("atcb-date-btn-content-icon"), (s.innerHTML = atcbIcon.ical), n.appendChild(s), document.createElement("span")),
        o =
            ((l.textContent = a),
            n.appendChild(l),
            null != u.recurrence && "" != u.recurrence && ((i = document.createElement("span")).classList.add("atcb-date-btn-content-recurr-icon"), n.appendChild(i), (i.innerHTML = "&#x27F3;")),
            document.createElement("div"));
    o.classList.add("atcb-date-btn-hover"), (o.innerHTML = t), r.appendChild(o), u.checkmark && ((s = document.createElement("div")).classList.add("atcb-checkmark"), (s.innerHTML = atcbIcon.checkmark), e.appendChild(s));
}
function get_format_options(e) {
    return {
        DateShort: { timeZone: e, year: "numeric" },
        DateLong: { timeZone: e, year: "numeric", month: "numeric", day: "numeric" },
        DateTimeShort: { timeZone: e, year: "numeric", hour: "numeric", minute: "2-digit", hourCycle: "h23" },
        DateTimeLong: { timeZone: e, year: "numeric", month: "numeric", day: "numeric", hour: "numeric", minute: "2-digit", hourCycle: "h23" },
        Time: { timeZone: e, hour: "numeric", minute: "2-digit", hourCycle: "h23" },
    };
}
function atcb_generate_links(e, a, t = "all", n = !1, o = !1) {
    if (("all" != t ? (t = parseInt(t) - 1) : 1 == a.dates.length && (t = 0), a.subscribe)) atcb_generate_subscribe_links(e, a, n);
    else if ((!isMobile() || ("msteams" != e && "ms365" != e && "outlookcom" != e) || (e = "ical"), "all" != t)) {
        if ("CANCELLED" == a.dates["" + t].status && "apple" != e && "ical" != e) atcb_create_modal(a, "warning", atcb_translate_hook("Cancelled Date", a), atcb_translate_hook("Delete from Calendar", a), [], [], n);
        else
            switch (e) {
                case "apple":
                case "ical":
    ...
    } else atcb_generate_multidate_links(e, a, n, o);
}
function atcb_generate_multidate_links(a, t, e, n) {
    if (
        ("ical" != a && "apple" != a) ||
        !t.dates.every(function (e) {
            return "CANCELLED" != e.status && (null == e.organizer || "" == e.organizer);
        })
    ) {
        if (!n) {
            var o = [a];
            for (let e = 0; e < t.dates.length; e++) o.push(e + 1);
        ...
        for (let e = 0; e < atcbStates["" + t.identifier]["" + a].length; e++) atcbStates["" + t.identifier]["" + a]["" + e]++;
        ...
        case "yahoo":
            return (
                ...
                void atcb_create_modal(
                    ...
                    [{ label: atcb_translate_hook("Open Yahoo Calendar", a), primary: !0, type: "yahoo2nd", href: "https://www.yahoo.com/calendar" }, { label: atcb_translate_hook("Cancel", a) }],
                    [],
                    t
                )
            );
...
function atcb_set_fully_successful(e, a) {
    ...
    e && e.classList.add("atcb-saved"), atcb_saved_hook(), a && document.querySelectorAll(".atcb-modal[data-modal-nr]").length < 2 && atcb_toggle("close");
}
...
function atcb_subscribe_microsoft(e, a, t = "365") {
    ...
    n.push("url=" + encodeURIComponent(e)), n.push("name=" + encodeURIComponent(a)), atcb_open_cal_url(t + n.join("&"));
}
function atcb_generate_google(e) {
    var a = [],
        t = (a.push("https://calendar.google.com/calendar/render?action=TEMPLATE"), atcb_generate_time(e, "clean", "google")),
        t =
            (a.push("dates=" + encodeURIComponent(t.start) + "%2F" + encodeURIComponent(t.end)),
    ...
    null != e.description && "" != e.description && t.push(e.description),
        null != e.location && "" != e.location && (a.push("location=" + encodeURIComponent(e.location)), isiOS() && (0 < t.length && t.push("<br><br>"), t.push("&#128205;: " + e.location))),
        ...
        null != e.availability && "" != e.availability && ((t = "free" == e.availability ? "crm=AVAILABLE&trp=false" : "crm=BUSY&trp=true"), a.push(t)),
        a.push("uid=" + encodeURIComponent(e.uid)),
        atcb_open_cal_url(a.join("&"));
}
function atcb_generate_yahoo(e) {
    var a = [],
        t = (a.push("https://calendar.yahoo.com/?v=60"), atcb_generate_time(e, "clean"));
...
function atcb_generate_microsoft(e, a = "365") {
    ...
    (a = "outlook" == a ? "https://outlook.live.com" + n : "https://outlook.office.com" + n), t.push(a), (a = atcb_generate_time(e, "delimiters", "microsoft"));
...
function atcb_generate_msteams(e) {
    ...
    a.push("startTime=" + encodeURIComponent(t.start)), a.push("endTime=" + encodeURIComponent(t.end)), null != e.name && "" != e.name && a.push("subject=" + encodeURIComponent(e.name));
    let n = "";
    null != e.location && "" != e.location && ((n = encodeURIComponent(e.location)), a.push("location=" + n), (n += " // ")),
...
function atcb_open_cal_url(e, a = "") {
    "" == a && (a = atcbDefaultTarget), atcb_secure_url(e) && window.open(e, a).focus();
}
function atcb_generate_ical(a, e = "all", t = !1) {
    ...
    if ("" == o || (isiOS() && isWebView())) {
        ...
        const c = ["BEGIN:VCALENDAR", "VERSION:2.0"],
            d =
                (c.push("PRODID:-// https://add-to-calendar-pro.com // button v" + atcbVersion + " //EN"),
                c.push("CALSCALE:GREGORIAN"),
                "all" == e
                    ? c.push("METHOD:PUBLISH")
                    : null != a.dates["" + e].status && "CANCELLED" == a.dates["" + e].status
                    ? c.push("METHOD:CANCEL")
                    : null != a.dates["" + e].organizer && "" != a.dates["" + e].organizer
        ...
        for (let e = l; e <= r; e++) {
            ...
            var s = u.allday
                ? ";VALUE=DATE"
                : null != a.dates["" + e].timeZone && "" != a.dates["" + e].timeZone
                ? ((s = tzlib_get_ical_block(a.dates["" + e].timeZone)), d.includes(a.dates["" + e].timeZone) || c.push(s[0]), d.push(a.dates["" + e].timeZone), ";" + s[1])
                : void 0;
            c.push("BEGIN:VEVENT"),
                ...
                null != a.dates["" + e].description &&
                    "" != a.dates["" + e].description &&
                    c.push(
                        'X-ALT-DESC;FMTTYPE=text/html:\r\n <!DOCTYPE HTML PUBLIC ""-//W3C//DTD HTML 3.2//EN"">\r\n <HTML><BODY>\r\n ' + a.dates["" + e].description.replace(/\n/g, "<br>").replace(/.{60}/g, "$&\r\n ") + "\r\n </BODY></HTML>"
                    ),
                null != a.dates["" + e].location && "" != a.dates["" + e].location && c.push("LOCATION:" + a.dates["" + e].location),
                null != a.dates["" + e].organizer && "" != a.dates["" + e].organizer && ((s = a.dates["" + e].organizer.split("|")), c.push("ORGANIZER;CN=" + s[0] + ":MAILTO:" + s[1])),
                null != a.recurrence && "" != a.recurrence && c.push(a.recurrence),
                null != a.dates["" + e].availability && "" != a.dates["" + e].availability && ((s = "free" == a.dates["" + e].availability ? "TRANSPARENT" : "OPAQUE"), c.push("TRANSP:" + s)),
    ...
    } else atcb_save_file(o, n);
}
function atcb_determine_ical_filename(e, a) {
    a = "all" != a && 0 != a ? "-" + parseInt(a) + 1 : "";
    if (null != e.iCalFileName && "" != e.iCalFileName) return e.iCalFileName + a;
...
function atcb_save_file(e, a) {
    try {
        var t = document.createElementNS("http://www.w3.org/1999/xhtml", "a"),
            n = ((t.rel = "noopener"), (t.href = e), isMobile() ? (t.target = "_self") : (t.target = "_blank"), (t.download = a + ".ics"), new MouseEvent("click", { view: window, button: 0, bubbles: !0, cancelable: !1 }));
...
function atcb_generate_time(e, a = "delimiters", t = "general", n = !1) {
    if (null == e.startTime || "" == e.startTime || null == e.endTime || "" == e.endTime)
        return (
            ...
            { start: atcb_format_datetime(o, a, !1), end: atcb_format_datetime(i, a, !1), allday: !0 }
        );
    {
        ...
        if ((null == e.timeZone || (null != e.timeZone && "" == e.timeZone)) && n) return { start: o.toISOString().replace(".000Z", "+00:00"), end: i.toISOString().replace(".000Z", "+00:00"), duration: l, allday: !1 };
        if (null != e.timeZone && "" != e.timeZone) {
            if ("ical" == t || ("google" == t && !/(GMT[+|-]\d{1,2}|Etc\/U|Etc\/Zulu|CET|CST6CDT|EET|EST|EST5EDT|MET|MST|MST7MDT|PST8PDT|WET)/i.test(e.timeZone)))
                return { start: atcb_format_datetime(o, "clean", !0, !0), end: atcb_format_datetime(i, "clean", !0, !0), duration: l, allday: !1 };
            (t = tzlib_get_offset(e.timeZone, e.startDate, e.startTime)), (e = tzlib_get_offset(e.timeZone, e.endDate, e.endTime));
            if (n) return (n = t.slice(0, 3) + ":" + t.slice(3)), (r = e.slice(0, 3) + ":" + e.slice(3)), { start: o.toISOString().replace(".000Z", n), end: i.toISOString().replace(".000Z", r), duration: l, allday: !1 };
            ...
            o.setTime(o.getTime() + n), i.setTime(i.getTime() + r);
        }
        return { start: atcb_format_datetime(o, a), end: atcb_format_datetime(i, a), duration: l, allday: !1 };
    }
}
...
function atcb_secure_url(e, a = !0) {
    return (
        ...
        ) || (a && console.error("Seems like the generated URL includes at least one security issue and got blocked. Please check the calendar button parameters!"), !1)
    );
}
function atcb_validEmail(e, a = !1) {
    return !!/^.{0,70}@.{1,30}\.[\w.]{2,9}$/.test(e) && (a && console.log("Testing for MX records not yet available"), !0);
}
function atcb_rewrite_html_elements(e, a = !1) {
    return (
        (e = e.replace(/<br\s*\/?>/gi, "\n")),
        (e = a
            ? e.replace(/\[(|\/)(url|br|hr|p|b|strong|u|i|em|li|ul|ol|h\d)\]|((\|.*)\[\/url\])/gi, "")
            : (e = e.replace(/\[(\/|)(br|hr|p|b|strong|u|i|em|li|ul|ol|h\d)\]/gi, "<$1$2>")).replace(/\[url\]([\w&$+.,:;=~!*'?@^%#|\s\-()/]*)\[\/url\]/gi, function (e, a) {
                  const t = a.split("|");
...
function atcb_position_list(e, a, t = !1, n = !1) {
    let o = !1;
    var i = e;
    null !== e.querySelector(".atcb-dropdown-anchor") && ((e = e.querySelector(".atcb-dropdown-anchor")), (o = !0));
    ...
    var s = i.getBoundingClientRect(),
        ...
        d =
            (null !== d && (d.style.height = c + "px"),
            !0 !== o || a.classList.contains("atcb-dropoverlay")
                ? ((a.style.minWidth = s.width + 20 + "px"), (r = a.getBoundingClientRect()), (a.style.top = window.scrollY + s.top + s.height / 2 - r.height / 2 + "px"), (a.style.left = s.left - (r.width - s.width) / 2 + "px"))
                : ((a.classList.contains("atcb-dropup") && n) || (!t && !n && l.top + r.height > c - 20 && 20 < 2 * s.top + s.height - l.top - r.height)
                      ? (i.classList.add("atcb-dropup"), a.classList.add("atcb-dropup"), (a.style.bottom = 2 * c - (c + (s.top + (s.top + s.height - l.top))) - window.scrollY + "px"))
                      : ((a.style.top = window.scrollY + l.top + "px"), i.classList.contains("atcb-dropup") && i.classList.remove("atcb-dropup")),
    ...
    d &&
        (i.classList.contains("atcb-dropup")
            ? ((d.style.top = window.scrollY + s.top + s.height + "px"), (d.style.left = s.left + (s.width - 150) / 2 + "px"))
            : ((r = a.getBoundingClientRect()),
...
function atcb_set_sizes(e, a) {
    e.style.setProperty("--base-font-size-l", a.l + "px"), e.style.setProperty("--base-font-size-m", a.m + "px"), e.style.setProperty("--base-font-size-s", a.s + "px");
}
...
function atcb_copy_to_clipboard(e) {
    var a,
        ...
        o = (document.body.appendChild(n), n.contentEditable),
        i = n.readOnly;
    (n.value = e),
        (n.contentEditable = !0),
        (n.readOnly = !1),
        isiOS() ? ((a = document.createRange()).selectNodeContents(n), (t = window.getSelection()).removeAllRanges(), t.addRange(a), n.setSelectionRange(0, 999999)) : (navigator.clipboard.writeText(e), n.select()),
        (n.contentEditable = o),
        (n.readOnly = i),
...
function atcb_throttle(n, o = 10) {
    let i,
        ...
        r = 0,
        s = (...e) => {
            (r = Date.now()), (l = null), (i = n.apply(this, e));
        };
    return (...e) => {
        var a = Date.now(),
            t = o - (a - r);
        return t <= 0 || o < t ? (l && (clearTimeout(l), (l = null)), (r = a), (i = n.apply(this, e))) : (l = l || setTimeout(s, t)), i;
    };
}
const i18nStrings = {
    en: {
    ...
    fr: {
        ...
        "modal.webview.ical.steps": "<ol><li><strong>Ouvre un autre navigateur</strong> sur ton smartphone, ...</li><li>Utilise la fonction <strong>insérer</strong> pour continuer.</li></ol>",
        ...
        "modal.crios.ical.steps": "<ol><li><strong>Ouvre Safari</strong>, ...</li><li>Utilise la fonction <strong>insérer</strong> pour continuer.</li></ol>",
...
function atcb_translate(e, a) {
    return (a = a || "en"), i18nStrings["" + a]["" + e] || e;
}
let atcbInitialInit = !1;
function atcb_init() {
    if ((atcbInitialInit || atcb_set_global_event_listener(), atcb_init_log_msg(), isBrowser())) {
        const o = document.querySelectorAll(".atcb");
        var a = [];
        if (0 < o.length) {
            var t,
                n = document.querySelectorAll(".atcb-initialized");
            for (let e = 0; e < o.length; e++)
                o[parseInt(e)].classList.contains("atcb-initialized") ||
                    (0 !=
                        (t = atcb_get_pro_data(
                            atcb_patch_config(
                                (function () {
                        ...
                        atcb_check_required(t) &&
                        ((null != (t = atcb_decorate_data(t)).identifier && "" != t.identifier) || (t.identifier = "atcb-btn-" + (e + n.length + 1)),
                        atcb_validate(t) && (atcb_generate_button(o[parseInt(e)], t), atcb_update_state_management(t), a.push(t.identifier))));
        }
        return a;
    }
...
function atcb_action(e, a, t = !0) {
    if ((atcbInitialInit || atcb_set_global_event_listener(), atcb_init_log_msg(), !atcb_check_required((e = atcb_get_pro_data((e = atcb_secure_content(e)))))))
        throw new Error("Add to Calendar Button generation failed: required data missing; see console logs");
    if (
        ((e = atcb_decorate_data(e)),
        a
            ? (null != a.id && "" != a.id ? (e.identifier = a.id) : null != e.identifier && "" != e.identifier ? (a.id = e.identifier) : (e.identifier = "atcb-btn-custom"), "dropdown" == e.listStyle && (e.listStyle = "overlay"))
            : ((e.identifier = "atcb-btn-custom"), (e.listStyle = "modal"), (e.trigger = "click")),
        atcb_validate(e))
    )
        return atcb_update_state_management(e), atcb_toggle("open", e, a, t), console.log('Add to Calendar Button "' + e.identifier + '" triggered'), [e.identifier];
...
function atcb_destroy(e) {
    ...
    return null != atcbStates["" + e] && a
        ? (delete atcbStates["" + e], (a.parentElement.parentElement.classList.contains("atcb-initialized") ? a.parentElement.parentElement : a).remove(), console.log('Add to Calendar Button "' + e + '" destroyed'), !0)
        : (console.error("Add to Calendar Button could not be destroyed! ID unknown."), !1);
}
function atcb_update_state_management(t) {
    var n = [];
    for (let a = 0; a < t.options.length; a++) {
        n[t.options["" + a]] = [];
        for (let e = 1; e <= t.dates.length; e++) n[t.options["" + a]].push(0);
    }
    atcbStates[t.identifier] = n;
}
function atcb_init_log_msg() {
    atcbInitialInit || (console.log("Add to Calendar Button Script initialized (version " + atcbVersion + ")"), console.log("See https://github.com/add2cal/add-to-calendar-button for details"), (atcbInitialInit = !0));
}
function atcb_get_pro_data(e) {
    return null != e.proKey && "" != e.proKey ? (console.error("Add to Calendar Button generation failed: proKey invalid!"), []) : e;
}
function atcb_set_global_event_listener() {
    isBrowser() &&
            ...
            if (document.querySelector(".atcb-list") && ("ArrowDown" === a.key || "ArrowUp" === a.key || "Tab" === a.key)) {
                ...
                if (t.classList.contains("atcb-list-item"))
                    "ArrowDown" === a.key && t.dataset.optionNumber < n
                        ...
                        : "ArrowUp" === a.key && 1 <= t.dataset.optionNumber && (a.preventDefault(), (e = parseInt(t.dataset.optionNumber) - 1)),
        ...
        window.addEventListener(
            ...
            atcb_throttle(() => {
                var e,
                    a = document.getElementById("atcb-bgoverlay"),
                    a = (null != a && (atcb_set_fullsize(a), atcb_manage_body_scroll()), document.querySelector(".atcb-active"));
        ...
        window.addEventListener(
            ...
            atcb_throttle(() => {
                var e,
                    a = document.querySelector(".atcb-active");
...
!(function (e, t) {
    ...
    function ue(e, t, o) {
        Y(e, o[`show${i(t)}Button`], "inline-block"), H(e, o[`${t}ButtonText`]), e.setAttribute("aria-label", o[`${t}ButtonAriaLabel`]), (e.className = n[t]), D(e, o, `${t}Button`), F(e, o[`${t}ButtonClass`]);
    }
    const de = (e, t) => {
        const o = m();
        o &&
    ...
    const Ce = (t, o) => {
            const i = w();
            D(i, o, "htmlContainer"),
                o.html ? (se(o.html, i), W(i, "block")) : o.text ? ((i.textContent = o.text), W(i, "block")) : z(i),
                ((t, o) => {
                    const i = f(),
        ...
        Ee = (e, t) => {
            (e.className = `${n.popup} ${Z(e) ? t.showClass.popup : ""}`),
                t.toast ? (F([document.documentElement, document.body], n["toast-shown"]), F(e, n.toast)) : F(e, n.modal),
                D(e, t, "popup"),
        ...
        Se = (t, i) => {
            ((e, t) => {
                const n = m(),
                    o = f();
                t.toast ? (_(n, "width", t.width), (o.style.width = "100%"), o.insertBefore(P(), b())) : _(o, "width", t.width),
    ...
    const je = () => k() && k().click(),
        ...
        Ve = (t, n, o) => {
            ...
            i &&
                (n.isComposing ||
                    229 === n.keyCode ||
                    (i.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key ? Ne(t, n, i) : "Tab" === n.key ? Fe(n, i) : [...De, ...qe].includes(n.key) ? Re(n.key) : "Escape" === n.key && Ue(n, i, o)));
        },
        Ne = (e, t, n) => {
    ...
    const We = () => {
        ...
        Xe = () => {
            null === M.previousBodyPadding &&
                ...
                ((M.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right"))),
    ...
    var At = Object.freeze({
        ...
        update: function (t) {
            ...
            const i = yt(t),
                r = Object.assign({}, o, i);
            Se(this, r), e.innerParams.set(this, r), Object.defineProperties(this, { params: { value: Object.assign({}, this.params, t), writable: !1, enumerable: !0 } });
        },
        _destroy: function () {
            const t = e.domCache.get(this),
    ...
    const kt = (e) => {
        ...
        $t = (e, t) => {
            ...
            u(t.inputOptions) || p(t.inputOptions)
                ...
                ? o(t.inputOptions)
                : r("Unexpected type of inputOptions! Expected object, Map or Promise, got " + typeof t.inputOptions);
        },
        Tt = (e, t) => {
            const n = e.getInput();
            z(n),
    ...
    const wn = (t, n, o) =>
        ...
        Cn = (t) => {
            const n = { popup: f(), container: m(), actions: E(), confirmButton: k(), denyButton: B(), cancelButton: x(), loader: P(), closeButton: S(), validationMessage: A(), progressSteps: C() };
